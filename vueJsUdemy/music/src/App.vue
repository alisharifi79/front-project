...
<div class="bg-gray-300 pb-24">
  ...
  <section class="container mx-auto">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      <!-- Playlist -->
      <ol id="playlist" class="bg-gray-200">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <form>
            ...
            <!-- Email -->
            <div class="mb-3">
              <label for="email-2" class="inline-block mb-2">Email
            ...
            <!-- Password -->
            <div class="mb-3">
              <label for="password-2" class="inline-block mb-2">Password
            ...
            <!-- Confirm Password -->
            <div class="mb-3">
              <label for="conf-password" class="inline-block mb-2">Confirm Password
            ...
            <!-- Country -->
            <div class="mb-3">
              <label for="counrty" class="inline-block mb-2">Country
              <select
                id="counrty"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded">
            ...
            <!-- TOS -->
            <div class="mb-3 pl-6">
              <label for="checkbox" class="inline-block">Accept terms of service
